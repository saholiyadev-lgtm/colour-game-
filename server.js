...
app.post('/api/deposit', async (req, res) => {
    ...
    res.json({ message: "Deposit request submitted! Admin approval pachi balance add thashe." });
});
    ...
    <body>
        <div class="container">
            ...
            <div id="adminSection" class="card hidden">
                ...
                <div style="overflow-x:auto; max-height:150px; margin-bottom: 15px;">
                    <table>
                        <thead>
                            <tr><th>User Account</th><th>Balance</th></tr>
                        </thead>
        ...
        <script>
            ...
            async function adminLogin() {
                ...
                if (res.ok) {
                    ...
                    showAdminDashboard();
                } else { document.getElementById('authMsg').innerText = "Invalid Admin Credentials!"; }
            }
